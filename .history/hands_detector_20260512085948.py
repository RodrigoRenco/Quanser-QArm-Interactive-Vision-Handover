...
def dedo_indice_extendido(hand_landmarks):
    return (
...
def pulgar_extendido(hand_landmarks):
    thumb_tip = hand_landmarks.landmark[4]
    thumb_mcp = hand_landmarks.landmark[2]

    distancia_x = abs(thumb_tip.x - thumb_mcp.x)

    return distancia_x > 0.1
...
def es_apuntar_derecha(hand_landmarks):
    ...
    # ÍNDICE
    # ==========
    if dedo_indice_extendido(hand_landmarks):
    ...
    # PULGAR
    # ==========
    if pulgar_extendido(hand_landmarks):
